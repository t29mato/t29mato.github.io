...
- [Plan-view incident chart (Claude Opus 5)](/animations/kashimanada-headland-incident/)
- [Animated reenactment (Claude Fable 5)](/animations/kashimanada-headland-incident/animation.html)
- 14-panel infographic (GPT-5.5):

  ![14-panel infographic reconstructing the Kashima-nada headland incident, generated by GPT-5.5](/animations/kashimanada-headland-incident/gpt-5.5-infographic.png)
