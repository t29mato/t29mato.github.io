...
date: 2026-07-31
description: "A rip current nearly killed me at a headland beach on the Kashima-nada coast. I fed the full account into Claude Opus 5 and Claude Fable 5 and asked each to reconstruct it as a self-contained HTML animation."
tags: [surfing, claude, ai, safety]
---

A few years ago I was pulled into a headland current at Top Sante, a beach on the Kashima-nada coast, and came close to drowning. I recently wrote up the full account and asked two Claude models — **Claude Opus 5** and **Claude Fable 5** — to reconstruct it as a standalone HTML page, using an [official Ibaraki Prefecture headland pamphlet](https://www.pref.ibaraki.jp/doboku/kasen/coast/documents/headland_pamphlet.pdf) as geographic reference. This post is the write-up, plus links to both results.

## What happened

Top Sante is where I originally learned to surf, entering the water between two of the T-shaped headlands built along this stretch of coast. This particular session was about two days before a typhoon; the forecast (checked on BCM) put the wave height around 1.5 m.
...
Both are self-contained HTML pages — open either one directly.
